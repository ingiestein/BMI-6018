...
def recusion_mother(inlist):
    ...
    def recursive_inner(inlist:[int], recursionlevel=0, maxlevel=0, currentlist:[any]=[])->([int],int):
        """
    ...
    deepest_list,_ = recursive_inner(inlist=inlist,currentlist=inlist) # don't need the depth, so throw away that value when unpacking
    return [x+1 for x in deepest_list] # add 1 to each value and create a new list


if __name__ == "__main__":
    input_list = [1, 2, 3, 4, [5, 6, 7, [8, 9,1,3,4,65,6,43,3,4,5,56,3,4,5,56,45,4,3],45,4,3],[8, 9,1,3,4,65,6,43,3,4,5,56,[8, 9,1,3,4,65,6,43,[3,4,5,56,45,4,3],3,4,5,56,45,4,3],45,4,[8, 9,1,3,4,65,6,43,[3,4,5,56,[1,2,3,4],45,4,3],3]]]
